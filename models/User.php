...
/**
 *
 * Управление пользователем осуществляется из консоли
 *
 * Добавить : php yii users/create
 * Активировать : php yii users/activate
 *
 * и т.д., полный перечень возможностей в классе \app\commands\Users
 *
